...
import { DollarSign, Layers, Zap, Wallet, TrendingUp, Clock, Shield, ArrowRight } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground">
              USSC – The <span className="bg-gradient-jade bg-clip-text text-transparent">Jadechain</span> Stablecoin
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              USSC is a fiat-referenced digital dollar issued by Jadechain Technologies, Inc. for business-to-business commerce. 
              Designed to hold a target value of 1 USD per token and move across supported blockchains with low fees and fast finality.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="p-12 bg-card/80 backdrop-blur-sm border-primary/20 shadow-jade max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Start accepting USSC today
            </h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join forward-thinking businesses using USSC for faster, more efficient cross-border payments
            </p>
